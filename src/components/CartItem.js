...
function CartItem({image, name, quantity, price}) {
  return (
    <div className="grid grid-cols-12 gap-2 items-center">
      <div className="flex items-center gap-[10px] col-span-6">
        <img
          src={image}
      ...
      <h6 className="col-span-1 font-medium text-gray-500 text-center">
        <span className="text-sm">x</span>{quantity}
      </h6>
      <div className="col-span-3 text-purple-600 font-medium text-[15px] text-center">
        {rupiahConverter(quantity * price)}
      </div>
      <div className="col-span-2 flex justify-center p-1 text-gray-600 hover:text-red-500 cursor-pointer rounded bg-gray-100 w-fit mx-auto">
