...
function NewOrder() {
  ...
  return (
    <>
      <Helmet>
        <title>Create Order | Merchain</title>
      </Helmet>
          ...
          <form className="flex flex-col gap-4" onSubmit={submitHandler}>
            ...
            <div>
              ...
              <div className="my-1 justify-end flex gap-3 md:">
                <Link to="/app/orders" className="rounded py-3 hover:bg-purple-100 font-semibold text-sm px-6 text-purple-600 border-2 border-purple-600">
                  Batalkan
                </Link>
