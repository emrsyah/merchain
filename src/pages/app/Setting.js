...
function Setting() {
  ...
  // const [storeTimeBuka, setStoreTimeBuka] = useState(store?.storeTime);
  // const [storeTimeTutup, setStoreTimeTutup] = useState(store?.storeTime);
